# Backlog — ranked, not yet shipped
...
| Review-count trust gap (32 vs. competitors' hundreds) | Trust | 6 | 0.6 | — | — | Blocked — not a code fix, needs a review-request push from Anthony |
| Certification badges beyond BBB (competitors show SoftWash Systems/PWNA + exact $ coverage) | Trust | 4 | 0.5 | 2 | 1.00 | Needs Anthony to confirm what's actually held |
| Brand palette/font revert to written spec (`#F58220`/`#1B5B98`/`#333333`, Anton/Montserrat) | Copy + Trust | — | — | — | — | Blocked — Anthony's call, it's a redesign not a fix |
| Clean Club deposit + monthly structure (brief's original spec vs. current 10%-off structure) | Conv | — | — | — | — | Blocked — pricing/offer change needs Anthony |
